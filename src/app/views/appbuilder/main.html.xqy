        ...
        return
          <div class="result">
            <table border="0" width="100%">
              {if ($q eq "") then "" else <tr><td width="105">Relevance:</td><td>{fn:concat(fn:format-number($result/@confidence * 100, "#,###"), "%")}</td><td>&nbsp;</td></tr>}
              <tr><td>Year:</td><td><b>{$result/*:created_on/text()}</b></td><td align="right"><a target="_blank" href="view.xml?uri={$result/@uri}">Open XML</a></td></tr>
              <tr><td valign="top">Link:</td><td colspan="2"><a target="_blank" href="{$result/*:permalink/text()}">{$result/*:permalink/text()}</a></td></tr>
              <tr><td valign="top">Author:</td><td colspan="2"><b>{$result/*:author/text()}</b></td></tr>
              <tr><td valign="top">Title:</td><td colspan="2"><b>{$result/*:title/text()}</b></td></tr>
              <tr><td valign="top">Body:</td><td colspan="2" width="100%">{fn:normalize-space($result/*:body/text())}</td></tr>
              <tr><td valign="top">Comments:</td><td colspan="2">{$result/*:comment_count/text()}</td></tr>
              <tr>
